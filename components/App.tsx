  ...
  return (
    <div className="fixed top-12 left-0 right-0 z-[1000] px-4 pointer-events-none flex flex-col gap-3">
      {activeOverlays.map((n) => (
        ...
        >
          <div className={`w-10 h-10 rounded-xl flex items-center justify-center text-white shrink-0 shadow-lg ${n.type === 'promo' ? 'bg-red-500' : 'bg-sky-500'}`}>
          ...
          <div className="flex-1 pr-6">
            <div className="flex justify-between items-start">
              ...
              <span className="text-[9px] text-sky-500 font-bold uppercase tracking-widest whitespace-nowrap ml-2">Baru</span>
            </div>
...
export const App: React.FC = () => {
  ...
  const [linkedBanks, setLinkedBanks] = useState([
    { id: 'bca', name: 'Bank BCA', holder: 'Budi Setiawan', number: '1234****789', icon: 'fa-building-columns', color: 'text-sky-600', bg: 'bg-sky-50' },
        ...
        return (
          <div className="p-4 pt-12 h-screen bg-gray-50 overflow-y-auto hide-scrollbar">
            <div className="bg-white rounded-[2rem] p-6 shadow-sm flex flex-col items-center mb-4 relative overflow-hidden group border border-gray-50">
              <div className="absolute top-0 right-0 w-24 h-24 bg-sky-50 rounded-full blur-3xl -mr-12 -mt-12 opacity-50"></div>
              <div className="relative mb-3">
                ...
                <div className="absolute -bottom-0.5 -right-0.5 w-5 h-5 bg-sky-500 rounded-full border border-white flex items-center justify-center text-white text-[8px]"><i className="fa-solid fa-check"></i></div>
              </div>
              ...
              <button 
                ...
                className="mt-4 px-5 py-2 bg-sky-50 text-sky-600 text-[9px] font-black uppercase tracking-widest rounded-lg hover:bg-sky-500 hover:text-white transition-all active:scale-95"
              >
                {t.edit}
              </button>
            </div>
            ...
            <div className="space-y-1.5 pb-24">
              {[
                { label: t.payment, icon: 'fa-credit-card', view: AppView.METODE_PEMBAYARAN, color: 'text-sky-600' },
